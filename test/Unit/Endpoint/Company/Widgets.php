...
class WidgetsTest extends AbstractUnit
{
    ...
    public function testListAll()
    {
         ...
         */
        $array = ['status' => true, 'data' => [0 => ['hash' => 'b863d45ef489ab31ed9571a951375717', 'label' => 'Dummy Widget', 'type' => 'embedded-widget', 'config' => json_encode(['gates' => 'gate_1']), 'creator_id' => 263517634, 'company_id' => 139419876, 'credential_id' => 113981357]]];
        /**
    ...
    public function testGetOne()
    {
         ...
         * Array response from the mock API call to widgets endpoint.
         */
        $array = ['status' => true, 'data' => ['hash' => 'b863d45ef489ab31ed9571a951375717', 'label' => 'Dummy Widget', 'type' => 'embedded-widget', 'config' => json_encode(['gates' => 'gate_1']), 'creator_id' => 263517634, 'company_id' => 139419876, 'credential_id' => 113981357]];
        /**
         * Mocks the HTTP Response.
         */
        $this->httpResponse = $this->getMockBuilder('GuzzleHttp\\Psr7\\Response')->getMock();
