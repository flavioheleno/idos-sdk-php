...
class CredentialsTest extends AbstractUnit
{
    ...
    public function testListAll()
    {
         ...
         */
        $array = ['status' => true, 'data' => [0 => ['company_id' => 4564658766, 'name' => 'My Test Key', 'slug' => 'my-test-key', 'public' => '4c9184f37cff01bcdc32dc486ec36961', 'private' => '2c17c6393771ee3048ae34d6b380c5ec', 'production' => 0, 'special' => 1, 'created_at' => time(), 'updated_at' => time()]]];
        /**
    ...
    public function testCreateNew()
    {
         ...
         */
        $array = ['status' => true, 'data' => ['company_id' => 4564658766, 'name' => 'My Test Key', 'slug' => 'my-test-key', 'public' => '4c9184f37cff01bcdc32dc486ec36961', 'private' => '2c17c6393771ee3048ae34d6b380c5ec', 'production' => 0, 'special' => 1, 'created_at' => time(), 'updated_at' => time()]];
        /**
         * Mocks the HTTP Response.
         */
        $this->httpResponse = $this->getMockBuilder('GuzzleHttp\\Psr7\\Response')->getMock();
