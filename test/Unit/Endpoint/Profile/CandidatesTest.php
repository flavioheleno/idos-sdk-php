...
{
    /**
     * Profile candidates endpoint instance.
     */
    ...
    public function testListAll()
    {
         ...
         */
        $array = ['status' => true, 'data' => [0 => ['attribute' => 'firstName', 'value' => 'Jhon', 'support' => 0.6, 'created_at' => time(), 'updated_at' => time()], 1 => ['attribute' => 'lastName', 'value' => 'Doe', 'support' => 0.7, 'created_at' => time(), 'updated_at' => time()], 2 => ['attribute' => 'gender', 'value' => 'male', 'support' => 0.8, 'created_at' => time(), 'updated_at' => time()]]];
        /**
    ...
    public function testCreateNew()
    {
         ...
         * Array response from the fake api call to Candidates endpoint.
         */
        $array = ['status' => true, 'data' => ['attribute' => 'firstName', 'value' => 'Jhon', 'support' => 0.6, 'created_at' => time(), 'updated_at' => time()]];
        /**
         * Mocks the HTTP Response.
         */
        $this->httpResponse = $this->getMockBuilder('GuzzleHttp\\Psr7\\Response')->getMock();
