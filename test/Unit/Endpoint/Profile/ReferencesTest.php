...
class ReferencesTest extends AbstractUnit
{
    ...
    public function testListAll()
    {
         ...
         */
        $array = ['status' => true, 'data' => [0 => ['name' => 'reference1', 'value' => 'value1', 'created_at' => time(), 'updated_at' => time()], 1 => ['name' => 'reference2', 'value' => 'value2', 'created_at' => time(), 'updated_at' => time()]]];
        /**
    ...
    public function testGetOne()
    {
         ...
         * Array response from the fake api call to References endpoint.
         */
        $array = ['status' => true, 'data' => ['name' => 'reference1', 'value' => 'value1', 'created_at' => time(), 'updated_at' => time()]];
        /**
         * Mocks the HTTP Response.
         */
        $this->httpResponse = $this->getMockBuilder('GuzzleHttp\\Psr7\\Response')->getMock();
