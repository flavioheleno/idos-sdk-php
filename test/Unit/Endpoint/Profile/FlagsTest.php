...
class FlagsTest extends AbstractUnit
{
    ...
    public function testListAll()
    {
         ...
         */
        $array = ['status' => true, 'data' => [0 => ['slug' => 'flag-slug', 'attribute' => 'attr', 'created_at' => time(), 'updated_at' => time()]]];
        /**
    ...
    public function testGetOne()
    {
         ...
         * Array response from the fake api call to Flags endpoint.
         */
        $array = ['status' => true, 'data' => ['slug' => 'flag-slug', 'attribute' => 'attr', 'created_at' => time(), 'updated_at' => time()]];
        /**
         * Mocks the HTTP Response.
         */
        $this->httpResponse = $this->getMockBuilder('GuzzleHttp\\Psr7\\Response')->getMock();
