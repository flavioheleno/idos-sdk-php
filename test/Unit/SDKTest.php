...
class SDKTest extends AbstractUnit
{
    ...
    {
        $this->assertInstanceOf(\idOS\Section\Profile::class, $this->sdk->profile('userName'));
    }
    public function testCompanySection()
    {
        $this->assertInstanceOf(\idOS\Section\Company::class, $this->sdk->company('company-slug'));
    }
    public function testGet()
    {
        $this->assertInstanceOf(\idOS\Endpoint\Sso::class, $this->invokeMethod($this->sdk, '__get', ['Sso']));
    }
