...
class AttributesTest extends AbstractFunctional
{
    ...
    {
        $this->sdk->Profile($this->credentials['username'])->Candidates->createNew('email', 'jhon@jhon.com', 0.9);
        $this->sdk->Profile($this->credentials['username'])->Candidates->createNew('gender', 'male', 0.9);
        ...
        $response  = $this->sdk->Profile($this->credentials['username'])->Attributes->listAll();
