...
class SourcesTest extends AbstractFunctional
{
    ...
    public function testListAll()
    {
        ...
        $this->sdk->Profile($this->credentials['username'])->Sources->createNew('name-test-1', ['tag-1' => 'value-1', 'tag-2' => 'value-2']);
        $this->sdk->Profile($this->credentials['username'])->Sources->createNew('name-test-2', ['tag-1' => 'value-1', 'tag-2' => 'value-2']);
        $response = $this->sdk->Profile($this->credentials['username'])->Sources->listAll();
    ...
    {
        $this->sdk->Profile($this->credentials['username'])->Sources->deleteAll();
        $response = $this->sdk->Profile($this->credentials['username'])->Sources->createNew('name-test', ['tag-1' => 'value-1', 'tag-2' => 'value-2']);
    ...
    {
        $response = $this->sdk->Profile($this->credentials['username'])->Sources->createNew('námé-test', ['tag-1' => 'value-1', 'tag-2' => 'value-2']);
    ...
    public function testDeleteAll()
    {
        ...
        $this->sdk->Profile($this->credentials['username'])->Sources->createNew('name-test-1', ['tag-1' => 'value-1', 'tag-2' => 'value-2']);
        $this->sdk->Profile($this->credentials['username'])->Sources->createNew('name-test-2', ['tag-1' => 'value-1', 'tag-2' => 'value-2']);
        $response = $this->sdk->Profile($this->credentials['username'])->Sources->deleteAll();
        $this->assertTrue($response['status']);
