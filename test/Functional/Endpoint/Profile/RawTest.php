...
class RawTest extends AbstractFunctional
{
    ...
    {
        $this->sdk->Profile($this->credentials['username'])->Raw->deleteAll();
        $this->sdk->Profile($this->credentials['username'])->Raw->createNew($this->sourceId, 'name-test-1', ['data-1' => [1, 2, 3], 'data-2' => [4, 5, 6]]);
        $this->sdk->Profile($this->credentials['username'])->Raw->createNew($this->sourceId, 'name-test-2', ['data-1' => [4, 5, 6], 'data-2' => [1, 2, 3]]);
        $response = $this->sdk->Profile($this->credentials['username'])->Raw->listAll();
    ...
    {
        $this->sdk->Profile($this->credentials['username'])->Raw->deleteAll();
        $response = $this->sdk->Profile($this->credentials['username'])->Raw->createNew($this->sourceId, 'name-test', ['data-1' => [1, 2, 3], 'data-2' => [4, 5, 6]]);
    ...
    {
        $this->sdk->Profile($this->credentials['username'])->Raw->deleteAll();
        $response = $this->sdk->Profile($this->credentials['username'])->Raw->createNew($this->sourceId, 'name-test', ['dátá-1' => [1, 2, 3], 'dátá-2' => [4, 5, 6]]);
        $this->assertTrue($response['status']);
        $this->assertNotEmpty($response['data']);
        $this->assertNotEmpty($response['data']['source']);
    ...
    public function testUpsertOne()
    {
        ...
        $this->assertNotEmpty($response['data']['source']);
        $this->assertSame(['data-1' => [1, 2, 3], 'data-2' => [4, 5, 6]], $response['data']['data']);
        $response = $this->sdk->Profile($this->credentials['username'])->Raw->upsertOne($this->sourceId, 'name-test', ['data-1' => [4, 5, 6], 'data-2' => [1, 2, 3]]);
        $this->assertTrue($response['status']);
        $this->assertNotEmpty($response['data']);
        $this->assertNotEmpty($response['data']['source']);
